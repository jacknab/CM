...
//
// Consumed by BOTH:
//   - pages/SettingsShell.tsx        (the macOS-style /settings rail + panes)
      ...
      items: [
        {
          ...
          icon: Settings, to: "/business-settings", slug: "business", iconBg: "bg-slate-100", iconColor: "text-slate-600",
        },
        {
          ...
          icon: Clock, to: "/business-hours", slug: "hours", iconBg: "bg-violet-100", iconColor: "text-violet-600",
        },
        {
          ...
          icon: Languages, to: "/language-settings", slug: "language", iconBg: "bg-indigo-100", iconColor: "text-indigo-600",
        },
      ],
    },
    {
      ...
      items: [
        {
          ...
          icon: CalendarDays, to: "/calendar-settings", slug: "booking-controls", iconBg: "bg-violet-100", iconColor: "text-violet-500",
        },
        {
          ...
          icon: Globe, to: "/online-booking", slug: "online-booking", iconBg: "bg-orange-100", iconColor: "text-orange-500",
        },
        {
          ...
          icon: Layers, to: "/settings/resources", slug: "resources", iconBg: "bg-teal-100", iconColor: "text-teal-600",
        },
        {
          ...
          icon: Tablet, to: "/kiosk-settings", slug: "kiosk", iconBg: "bg-sky-100", iconColor: "text-sky-600",
        },
      ],
    },
    {
      ...
      items: [
        {
          ...
          icon: CreditCard, to: "/manage/payment-settings", slug: "payments", external: true, iconBg: "bg-violet-100", iconColor: "text-violet-600",
        },
        {
          ...
          icon: Banknote, to: "/settings/payout-account", slug: "payout-account", iconBg: "bg-emerald-100", iconColor: "text-emerald-600",
        },
        {
          ...
          icon: ShoppingCart, to: "/pos-settings", slug: "pos", iconBg: "bg-teal-100", iconColor: "text-teal-600",
        },
      ],
    },
    {
      ...
      items: [
        {
          ...
          icon: Users, to: "/team", slug: "team", external: true, iconBg: "bg-indigo-100", iconColor: "text-indigo-500",
        },
        {
          ...
          icon: Wallet, to: "/payroll-settings", slug: "commission", iconBg: "bg-emerald-100", iconColor: "text-emerald-600",
        },
        {
          ...
          icon: Banknote, to: "/payroll", slug: "payroll", external: true, iconBg: "bg-amber-100", iconColor: "text-amber-600",
        },
      ],
    },
    {
      ...
      items: [
        {
          ...
          icon: MessageSquare, to: "/sms-settings", slug: "sms", iconBg: "bg-sky-100", iconColor: "text-sky-500",
        },
        {
          ...
          icon: Mail, to: "/mail-settings", slug: "email", iconBg: "bg-rose-100", iconColor: "text-rose-500",
        },
      ],
    },
    {
      ...
      items: [
        {
          ...
          icon: PhoneCall, to: "/manage/ai-receptionist", slug: "ai-receptionist", external: true, iconBg: "bg-rose-100", iconColor: "text-rose-500",
        },
        {
        ...
        },
        {
          ...
          icon: Sparkles, to: "/settings/translations", slug: "translations", iconBg: "bg-fuchsia-100", iconColor: "text-fuchsia-600",
        },
      ],
    },
    {
      ...
      items: [
        {
          ...
          icon: Zap, to: "/billing", slug: "subscription", external: true, iconBg: "bg-amber-100", iconColor: "text-amber-600",
        },
        {
          ...
          icon: ArrowLeftRight, to: "/manage/data-transfer", slug: "data-transfer", iconBg: "bg-orange-100", iconColor: "text-orange-500",
        },
        {
          ...
          icon: Sliders, to: "/features-settings", slug: "advanced", iconBg: "bg-blue-100", iconColor: "text-blue-600",
        },
      ],
    },
  ];
