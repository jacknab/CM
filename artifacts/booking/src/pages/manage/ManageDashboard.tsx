...
export default function ManageDashboard() {
  ...
  const searchIndex: SearchEntry[] = [
    ...
    { label: t.lblStaffMgmt,          section: t.secSettings, sectionColor: "bg-slate-100 text-slate-600",  icon: Users,          iconBg: "bg-indigo-100",  iconColor: "text-indigo-500",  to: "/team",        keywords: "staff members roles permissions profiles schedule" },
    ...
    { label: t.lblStripeConnect,      section: t.secSettings, sectionColor: "bg-slate-100 text-slate-600",  icon: CreditCard,     iconBg: "bg-violet-100",  iconColor: "text-violet-600",  to: "/payments/payouts",    keywords: "stripe connect card payment processor account" },
    ...
    { label: t.lblPayoutsOverview,  section: t.secFinancePos, sectionColor: "bg-green-100 text-green-700",  icon: Wallet,        iconBg: "bg-rose-100",    iconColor: "text-rose-600",    to: "/payroll",            keywords: "payouts overview pending completed scheduled contractors" },
    { label: t.lblPayoutsLedger,    section: t.secFinancePos, sectionColor: "bg-green-100 text-green-700",  icon: BookOpen,      iconBg: "bg-orange-100",  iconColor: "text-orange-600",  to: "/payroll",     keywords: "ledger transactions payouts adjustments deductions" },
    { label: t.lblPayoutsReports,   section: t.secFinancePos, sectionColor: "bg-green-100 text-green-700",  icon: BarChart3,     iconBg: "bg-indigo-100",  iconColor: "text-indigo-600",  to: "/payroll",    keywords: "payout reports history breakdowns export" },

    // Staff & Earnings hub
    { label: t.lblStaffMembers,      section: t.secStaffEarnings, sectionColor: "bg-amber-100 text-amber-700", icon: Users2,        iconBg: "bg-amber-100",   iconColor: "text-amber-600",   to: "/team",   keywords: "staff members add technician permissions working hours profiles" },
    ...
    { label: t.lblContractors,       section: t.secStaffEarnings, sectionColor: "bg-amber-100 text-amber-700", icon: Users,         iconBg: "bg-violet-100",  iconColor: "text-violet-600",  to: "/team",   keywords: "contractors onboarding payout methods 1099 tax" },
    { label: t.lblEarningsByService, section: t.secStaffEarnings, sectionColor: "bg-amber-100 text-amber-700", icon: FileBarChart,  iconBg: "bg-rose-100",    iconColor: "text-rose-600",    to: "/commissions",     keywords: "earnings by service revenue ranked bookings average ticket" },
    { label: t.lblPayoutRun,         section: t.secStaffEarnings, sectionColor: "bg-amber-100 text-amber-700", icon: Banknote,      iconBg: "bg-green-100",   iconColor: "text-green-600",   to: "/payroll",           keywords: "payout run initiate contractor new confirm" },
    { label: t.lblDeductions,        section: t.secStaffEarnings, sectionColor: "bg-amber-100 text-amber-700", icon: DollarSign,    iconBg: "bg-slate-100",   iconColor: "text-slate-600",   to: "/payroll",    keywords: "deductions booth rent product fees standing charges" },
    { label: t.lblPayoutSchedule,    section: t.secStaffEarnings, sectionColor: "bg-amber-100 text-amber-700", icon: CalendarClock, iconBg: "bg-violet-100",  iconColor: "text-violet-600",  to: "/payroll",      keywords: "payout schedule automatic recurring weekly monthly" },
    { label: t.lblTaxDocs,           section: t.secStaffEarnings, sectionColor: "bg-amber-100 text-amber-700", icon: ScrollText,    iconBg: "bg-rose-100",    iconColor: "text-rose-600",    to: "/payroll",      keywords: "1099 tax documents forms contractors filing NEC" },
    { label: t.lblCommissionPayouts, section: t.secStaffEarnings, sectionColor: "bg-amber-100 text-amber-700", icon: FileCheck2,    iconBg: "bg-indigo-100",  iconColor: "text-indigo-600",  to: "/payroll",   keywords: "commission payouts breakdown service staff period" },
