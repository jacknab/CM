...
export default function ManageDashboard() {
  ...
  const searchIndex: SearchEntry[] = [
    ...
    { label: t.lblCommissionReport, section: t.secFinancePos, sectionColor: "bg-green-100 text-green-700",  icon: DollarSign,    iconBg: "bg-amber-100",   iconColor: "text-amber-600",   to: "/commissions",  keywords: "commission report per staff revenue earned" },
