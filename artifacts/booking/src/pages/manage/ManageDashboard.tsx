...
export default function ManageDashboard() {
  ...
  const searchIndex: SearchEntry[] = [
    ...
    { label: t.lblContentTranslations,section: t.secSettings, sectionColor: "bg-slate-100 text-slate-600",  icon: Languages,      iconBg: "bg-violet-100",  iconColor: "text-violet-600",  to: "/settings/business?tab=translations", keywords: "translate ai services categories language multilingual" },
    ...
    { label: t.lblPayoutAccount,      section: t.secSettings, sectionColor: "bg-slate-100 text-slate-600",  icon: Banknote,       iconBg: "bg-emerald-100", iconColor: "text-emerald-600", to: "/settings/pos?tab=payout-account", keywords: "bank account direct deposit identity verify payout" },
