...
async function buildAll() {
  ...
  // Intentionally do NOT wipe dist/ here.
  // `artifacts/booking` writes SPA assets to `artifacts/api-server/dist/public/`.
  // Removing dist during API-only builds causes production deep-link outages
  // (`Cannot GET /auth`, `/staff-auth`, etc.) until booking is rebuilt.
